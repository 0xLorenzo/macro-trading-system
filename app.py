...
# 取你的 Alpha Vantage API Key
ALPHA_KEY = st.secrets.get("ALPHA_VANTAGE_API_KEY")

st.set_page_config(page_title="宏观交易系统 V7 完整自动版", layout="wide")
...
def get_fedwatch_signal():
    # 利用 CME FedWatch 顾客概率 API (需合法获取)
    # 示例乱数，实际请替换为真实接口抓取
    # 例如 FedWatch Tool or CME API
    import random
...
st.download_button("📥 下载行情历史 CSV", download_csv, "market_history.csv")
